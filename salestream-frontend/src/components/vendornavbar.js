        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item mx-3">
              <Link 
                to="/products" 
                className={`nav-link fs-5 fw-bold ${location.pathname === '/products' ? 'text-primary' : ''}`}
                style={{ color: location.pathname === '/products' ? '#1827A4' : '' }}
              >
                Products
              </Link>
            </li>
            <li className="nav-item mx-3">
              <Link 
                to="/vendor-orders" 
                className={`nav-link fs-5 fw-bold ${location.pathname === '/vendor-orders' ? 'text-primary' : ''}`}
                style={{ color: location.pathname === '/vendor-orders' ? '#1827A4' : '' }}
              >
                Orders 
              </Link>
            </li>
